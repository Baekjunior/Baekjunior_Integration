...
String problemQuery = "SELECT * FROM problems WHERE user_id=? AND level=?";
	...
	<div id="main">
		<div id="main_bar">
			...
			<div id="sort"  class="content_set">
				...
				<ul style="top:205px;">
					<li><a href="3_Baekjunior.jsp?latest=true&level=<%=levelSort%>&tier_name=<%=tierNameSort%>&tier_num=<%=tierNumSort%>&search_range=<%=searchRange%>&search_keyword=<%=searchKeyword%>">Latest</a></li>
					<li><a href="3_Baekjunior.jsp?earliest=true&level=<%=levelSort%>&tier_name=<%=tierNameSort%>&tier_num=<%=tierNumSort%>&search_range=<%=searchRange%>&search_keyword=<%=searchKeyword%>">Earliest</a></li>
					<li><a href="3_Baekjunior.jsp?ascending=true&level=<%=levelSort%>&tier_name=<%=tierNameSort%>&tier_num=<%=tierNumSort%>&search_range=<%=searchRange%>&search_keyword=<%=searchKeyword%>">Ascending number</a></li>
					<li><a href="3_Baekjunior.jsp?descending=true&level=<%=levelSort%>&tier_name=<%=tierNameSort%>&tier_num=<%=tierNumSort%>&search_range=<%=searchRange%>&search_keyword=<%=searchKeyword%>">Descending number</a></li>
				</ul>
			</div>
			...
			<div id="search_selection" style="float:right;">
					<input type="hidden" id="level_search" value="<%=levelSort %>">
					<input type="hidden" id="tier_name_search" value="<%=tierNameSort %>">
					<input type="hidden" id="tier_num_search" value="<%=tierNumSort %>">
		...
		function searchNotes() {
	        ...
	        var levelSearch = document.getElementById("level_search").value;
	        var tierNameSearch = document.getElementById("tier_name_search").value;
	        var tierNumSearch = document.getElementById("tier_num_search").value;
		
	        window.location.href = '3_Baekjunior.jsp?level=' + levelSearch + '&tier_name=' + tierNameSearch + '&tier_num=' 
	        						+ tierNumSearch + '&search_range=' + searchRange + '&search_keyword=' + searchKeyword;
	    }
		</script>
