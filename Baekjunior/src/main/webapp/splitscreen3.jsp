...
<body>	
	...
	<div style="position:absolute; top: 50%; left: 50%; transform: translate(-50%, -50%);">
		<button onclick="location.href='#'" style="border-right:3px solid black; font-size:15px; font-weight:bold; width:60px;">Switch Sides</button>
	</div>
	...
	<div style="display:grid; grid-template-columns: 1fr 1fr;">
		...
		<div style=" width:80%; margin:0 auto;">
			<div style="float:right;">
				<button onclick="location.href='splitscreen2.jsp'" style="font-size:15px; font-weight:bold; border:3px solid black; padding:0 5px;">X</button>
			</div>
			<br><br>
			<div>
				<div>
...
int main() {
	...
	<div style="margin-top:20px; border-right:3px solid black;">
		<div style=" width:80%; margin:0 auto;">
			<div style="float:right;">
				<button onclick="location.href='splitscreen1.jsp'" style="font-size:15px; font-weight:bold; border:3px solid black; padding:0 5px;">X</button>
			</div>
			<br><br>
			<div>
				<div>
